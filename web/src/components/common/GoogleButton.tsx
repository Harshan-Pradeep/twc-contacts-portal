...
const GoogleButton: React.FC<GoogleButtonProps> = ({ onClick, isLoading }) => {
    return (
        <Button
            ...
            className="h-[50px] flex items-center justify-center gap-2 text-white bg-transparent hover:bg-transparent [box-shadow:0px_0px_0px_1px_white_inset] rounded-[50px] px-4"
        >
            ...
            <span className="font-FutuLight text-[20px]">
                Sign in with Google
            </span>
        </Button>
    );
